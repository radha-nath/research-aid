...
- `/research-study-aid <file or description>` — analyze the provided transcript or notes
- `/research-study-aid /report` — generate DOCX report from current analysis
- `/research-study-aid /deck` — generate PPTX deck from current analysis
- `/research-study-aid /journey` — produce journey map
- `/research-study-aid /arc` — produce emotional arc diagram
- `/research-study-aid /quoteboard` — produce annotated quote board

## Loading Transcripts

**Single file**: `/research-study-aid path/to/transcript.txt`

**Multiple files (space-separated)**: `/research-study-aid p1.txt p2.txt p3.txt`
...
**Directory of transcripts**: `/research-study-aid /path/to/transcripts/`
